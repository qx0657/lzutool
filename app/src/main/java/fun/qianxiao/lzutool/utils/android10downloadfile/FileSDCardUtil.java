...
public class FileSDCardUtil {
    ...
    public String getPublickDiskImagePicDir() {
        return getPublickDiskFileDir(MyApplication.getInstance(), DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMoviesDir() {
        return getPublickDiskFileDir(MyApplication.getInstance(), DIRECTORY_MOVIES);
    }
    ...
    public String getPublickDiskMusicDir() {
        return getPublickDiskFileDir(MyApplication.getInstance(), DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskImagePicCacheDir() {
        return getPublickDiskCacheDir(MyApplication.getInstance(), DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMusicCacheDir() {
        return getPublickDiskCacheDir(MyApplication.getInstance(), DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskMoviesCacheDir() {
        return getPublickDiskCacheDir(MyApplication.getInstance(), DIRECTORY_MOVIES);
    }
